...
public final class ObjectDefinition {
	...
	public static ObjectDefinition forID(int i) {
		...
		case 8720:
			...
			break;
		case 10060:
			objectDef.name = "Booth";
			break;
		case 162:
			objectDef.actions = new String[] { "Use", null, null, null, null };
			objectDef.name = "Blood Exchange";
			break;
		case 31948:
			objectDef.actions = new String[] { "Open", null, null, null, null };
			objectDef.name = "@red@Wilderness Chest";
			break;
		case 25187:
			objectDef.actions = new String[] { "Climb", null, null, null, null };
			objectDef.name = "Ugly Tree";
			break;
		case 22683:
			objectDef.actions = new String[] { "Open", null, null, null, null };
			objectDef.name = "TOB Chest";
			break;
		case 22845:
			objectDef.actions = new String[] { "Open", null, null, null, null };
			...
			break;
		case 31625:
			objectDef.actions = new String[] { "Look-inside", null, null, null, null };
			objectDef.name = "Imbue Fountain (i)";
			break;
		case 29132:
		case 29133:
			objectDef.actions = new String[] { null, null, null, null, null };
			objectDef.name = "Gambling Zone Fence";
			break;
		case 16695:
			objectDef.actions = new String[] { "Open", null, null, null, null };
        ...
        case 24150:
        case 6097:
        	objectDef.actions = new String[] { "Donate to", "Status", null, null, null };
			objectDef.name = "Well of Goodwill";
			break;
        case 26812:
		case 32546:
        	objectDef.actions = new String[] { "Open Shop", "Vote Now", "Exchange Tickets", null, null };
        ...
        case 31618:
        	...
        	objectDef.actions = new String[] { "Enter", null, null, null, null };
				break;
        case 29710:
        	objectDef.name = "Gear Table";
        	objectDef.actions = new String[] { "View", null, null, null, null };
				break;
        case 21181:
        	objectDef.name = "Christmas Event Dungeon";
        	objectDef.actions = new String[] { "Enter", null, null, null, null };
				break;
        case 31621:
