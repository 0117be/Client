...
public class RSFont extends DrawingArea {
	...
	public static String handleOldSyntax(String text) {
		...
		text = text.replaceAll("@cr27@", "<img=27>");
		text = text.replaceAll("@cr28@", "<img=28>");
		text = text.replaceAll("@cr29@", "<img=29>");
		text = text.replaceAll("@cr30@", "<img=30>");
		text = text.replaceAll("@cr31@", "<img=31>");
		text = text.replaceAll("@cr32@", "<img=32>");
		text = text.replaceAll("@cr33@", "<img=33>");
		text = text.replaceAll("@cr34@", "<img=34>");
		text = text.replaceAll("@cr35@", "<img=35>");
		text = text.replaceAll("@cr36@", "<img=36>");
		text = text.replaceAll("@cr37@", "<img=37>");
		text = text.replaceAll("@cr38@", "<img=38>");
		text = text.replaceAll("@cr39@", "<img=39>");
		text = text.replaceAll("@cr40@", "<img=40>");
		text = text.replaceAll("@cr41@", "<img=41>");
		text = text.replaceAll("@cr42@", "<img=42>");
		text = text.replaceAll("@cr43@", "<img=43>");
		text = text.replaceAll("@cr44@", "<img=44>");
		text = text.replaceAll("@cr45@", "<img=45>");
		text = text.replaceAll("@cr46@", "<img=46>");
		text = text.replaceAll("@cr47@", "<img=47>");
		text = text.replaceAll("@cr48@", "<img=48>");
		text = text.replaceAll("@cr49@", "<img=49>");
		text = text.replaceAll("@cr50@", "<img=50>");
		text = text.replaceAll("@cr51@", "<img=51>");
		text = text.replaceAll("@cr52@", "<img=52>");
		text = text.replaceAll("@cr53@", "<img=53>");
		text = text.replaceAll("@cr54@", "<img=54>");
		text = text.replaceAll("@cr55@", "<img=55>");
		text = text.replaceAll("@cr56@", "<img=56>");
		text = text.replaceAll("@cr57@", "<img=57>");
		text = text.replaceAll("@cr58@", "<img=58>");
		text = text.replaceAll("@cr59@", "<img=59>");
		text = text.replaceAll("@cr60@", "<img=60>");
		text = text.replaceAll("@cr61@", "<img=61>");
		text = text.replaceAll("@cr62@", "<img=62>");
		text = text.replaceAll("@cr63@", "<img=63>");
		return text;
	}
