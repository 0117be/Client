...
public class Configuration {
	...
	public static final int PORT = 43569;

	public static final String CLIENT_TITLE =  Configuration.LIVE_SERVER ? "Revelation" : "Revelation";
	...
	public static final String CACHE_NAME = ".revelation3.6";

	public static boolean repackIndexOne = false, repackIndexTwo = false, repackIndexThree = false,
			repackIndexFour = false;


		public static final String CACHE_LINK = "http://revelation-rsps.com/.revelation3.6.zip";
		
	public static final String VERSION_URL = "http://revelation-rsps.com/cachevers.txt";
	
	public static final String CLIENT_VERSION_URL = "http://revelation-rsps.com/clientvers.txt";
	
	public static final String CLIENT_URL = "http://revelation-rsps.com/Revelation.jar";
