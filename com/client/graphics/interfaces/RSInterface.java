...
public class RSInterface {
	...
	public static void achievementPopup2(TextDrawingArea[] tda) {
		...
		addText(36005, "Revelation Achievements", tda, 2, 0xff9040, true, true);
		addText(36550, "Rewards:", tda, 0, 0xFFA500, false, true);
    ...
    public static void infoTab(TextDrawingArea[] tda) {
        ...
        addText(47501, "", tda, 2, 16750899, false, true);
        addSprite(47502, 3, "Interfaces/infoTab/SPRITE");
        configHoverButton(47503, "Select", "Interfaces/infoTab/SPRITE", 4, 5, 5, 5, false, new int[] { 47503 });
        configHoverButton(47504, "Select", "Interfaces/infoTab/SPRITE", 4, 5, 5, 5, false, new int[] { 47504 });
        ...
        addText(47511, "<col=e6b800><shad=200>@cr25@ Dungeons</col>", tda, 1, 16750899, false, true);
        addText(47512, "<col=d633ff><shad=000>@cr26@Minigames</col>", tda, 1, 16750899, false, true);
        addText(47513, "<col=1aff1a><shad=3000>@cr20@Skilling</col>", tda, 1, 16750899, false, true);
        addText(47514, "@bla@@cr22@ Bosses", tda, 1, 16750899, false, true);
        addText(47515, "<col=ff0000>@cr21@Wilderness</col>", tda, 1, 16750899, false, true);
        addText(47516, "<col=ffffff><shad=63>@cr18@Cities</col>", tda, 1, 16750899, false, true);
        addText(47517, "@gre@@cr33@ Training</col>", tda, 1, 16750899, false, true);
        addText(47518, "@gre@@cr5@ Donator</col>", tda, 1, 16750899, false, true);
        
        tab.totalChildren(20);
        tab.child(0, 47501, 65, 7);
        tab.child(1, 47503, 9, 0);
        tab.child(2, 47504, 99, 0);
        tab.child(3, 47606, 0, 116);
        tab.child(4, 47505, 9, 27);
        tab.child(5, 47506, 9, 56);
        tab.child(6, 47507, 9, 85);
        tab.child(7, 47508, 99, 27);
        tab.child(8, 47509, 99, 56);
        tab.child(9, 47510, 99, 85);
        tab.child(10, 47502, 31, 5);
        tab.child(11, 47502, 140, 5);
        tab.child(12, 47511, 13, 32);
        tab.child(13, 47512, 13, 61);
        tab.child(14, 47513, 18, 90);
        tab.child(15, 47514, 107, 32);
        tab.child(16, 47515, 102, 61);
        tab.child(17, 47516, 112, 90);
        tab.child(18, 47517, 17, 5);
        tab.child(19, 47518, 105, 5);
    ...
    public static void gearSet(TextDrawingArea[] tda) {
        RSInterface tab = addTabInterface(57500);
        addText(57501, "", tda, 2, 16750899, false, true);
        addSprite(57502, 3, "Interfaces/infoTab/SPRITE");
        configHoverButton(57503, "Select", "Interfaces/infoTab/SPRITE", 4, 5, 5, 5, false, new int[] { 57503 });
        configHoverButton(57504, "Select", "Interfaces/infoTab/SPRITE", 4, 5, 5, 5, false, new int[] { 57504 });
        configHoverButton(57505, "Select", "Interfaces/infoTab/SPRITE", 4, 5, 5, 5, false, new int[] { 57505 });
        configHoverButton(57506, "Select", "Interfaces/infoTab/SPRITE", 4, 5, 5, 5, false, new int[] { 57506 });
        configHoverButton(57507, "Select", "Interfaces/infoTab/SPRITE", 4, 5, 5, 5, false, new int[] { 57507 });
        configHoverButton(57508, "Select", "Interfaces/infoTab/SPRITE", 4, 5, 5, 5, false, new int[] { 57508 });
        configHoverButton(57509, "Select", "Interfaces/infoTab/SPRITE", 4, 5, 5, 5, false, new int[] { 57509 });
        configHoverButton(57510, "Select", "Interfaces/infoTab/SPRITE", 4, 5, 5, 5, false, new int[] { 57510 });
       
        addText(57511, "@or1@ Hybrid Sets", tda, 1, 16750899, false, true);
        addText(57512, "@or1@ Tribrid Sets", tda, 1, 16750899, false, true);
        addText(57513, "@or1@ ", tda, 1, 16750899, false, true);
        addText(57514, "@or1@ Zerker Sets", tda, 1, 16750899, false, true);
        addText(57515, "@or1@ Main Sets", tda, 1, 16750899, false, true);
        addText(57516, "@or1@ ", tda, 1, 16750899, false, true);
        addText(57517, "@or1@ Whip/dds", tda, 1, 16750899, false, true);
        addText(57518, "@or1@ Pure Sets", tda, 1, 16750899, false, true);
        
        tab.totalChildren(20);
        tab.child(0, 57501, 65, 7);
        tab.child(1, 57503, 9, 0);
        tab.child(2, 57504, 99, 0);
        tab.child(3, 57606, 0, 116);
        tab.child(4, 57505, 9, 27);
        tab.child(5, 57506, 9, 56);
        tab.child(6, 57507, 9, 85);
        tab.child(7, 57508, 99, 27);
        tab.child(8, 57509, 99, 56);
        tab.child(9, 57510, 99, 85);
        tab.child(10, 57502, 31, 5);
        tab.child(11, 57502, 140, 5);
        tab.child(12, 57511, 13, 32);
        tab.child(13, 57512, 13, 61);
        tab.child(14, 57513, 18, 90);
        tab.child(15, 57514, 107, 32);
        tab.child(16, 57515, 102, 61);
        tab.child(17, 57516, 112, 90);
        tab.child(18, 57517, 17, 5);
        tab.child(19, 57518, 105, 5);

        RSInterface scrollsection = addTabInterface(57606);
        scrollsection.height = 136; //196
        scrollsection.width = 174;
        scrollsection.scrollMax = 440;
        scrollsection.newScroller = false;       
        ...
        int Ypos = 0;
        int frameID = 0;
        for(int iD = 57607; iD <= 57627; iD++) {
        	configHoverButton(iD, "Preset", "Interfaces/infoTab/SPRITE", 6, 7, 7, 7, false, new int[] { iD });
        	scrollsection.child(frameID, iD, 0, Ypos);
        	frameID++;
        	Ypos += 22;
        }
        ...
        for(int iD = 57628; iD <= 57648; iD++) {
        	//System.out.print(iD + ", ");
        	addText(iD, "@or1@Preset name" + iD, tda, 1, /*16750899*/1022259, false, true);
        	scrollsection.child(frameID, iD, 5, Ypos);
        	frameID++;
        	Ypos += 22;
        }
	...
	public static void questTab(TextDrawingArea[] tda) {
		...
		addText(10222, "@or1@Revelation", tda, 2, 16750899, true, true);
		...
		tab.child(3, 10405, 96, 12);
		tab.child(4, 10406, 52, 13);
